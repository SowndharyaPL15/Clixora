  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-500 via-indigo-600 to-purple-600 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="absolute bottom-[25%] right-[20%] w-[120px] h-[120px] rounded-full border border-white/10"></div>
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-4">
              ...
              <div className="text-xs text-white/60 font-medium mt-1">Links</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-4">
              <div className="text-2xl font-extrabold text-white">14d</div>
              <div className="text-xs text-white/60 font-medium mt-1">Analytics</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-4">
              <div className="text-2xl font-extrabold text-white">CSV</div>
              <div className="text-xs text-white/60 font-medium mt-1">Bulk Import</div>
            </div>
          </div>
        </div>
      </div>
